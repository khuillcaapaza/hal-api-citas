...
final class AuthController extends Controller
{
    ...
    private function enviarCodigo(string $email, string $nombre, string $codigo): void
    {
        ...
        $asunto  = 'Tu código de acceso · Sistema para el Cronograma de Atención de Citas';

        $html = '<div style="font-family:Arial,Helvetica,sans-serif;max-width:480px;margin:0 auto">'
            . '<h2 style="color:#0d6efd;margin-bottom:4px">Sistema para el Cronograma de Atención de Citas</h2>'
        ...
        $texto = "Sistema para el Cronograma de Atención de Citas - Hospital Antonio Lorena\n\n"
